...
import { MarketData, MarketDriver } from '@/lib/market-calculations';
import { EditableValueCell } from '@/components/business-case/EditableValueCell';
import { EditableRationaleCell } from '@/components/business-case/EditableRationaleCell';
import { SensitivityDriverBadge } from '@/components/business-case/SensitivityDriverBadge';
import { extractMarketAssumptions, groupAssumptionsByCategory, getCategoryOrder } from '@/lib/market-path-utils';

export function MarketAssumptionsTab() {
  const { appState, updateMarketAssumption, addMarketDriver, removeMarketDriver, updateMarketDriverRange } = useApp();
  ...
  const handleValueUpdate = (path: string, value: any) => {
    updateMarketAssumption(path, value);
